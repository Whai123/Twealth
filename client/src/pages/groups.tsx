...
export default function Groups() {
 ...
 {/* Spectacular Header */}
 <header className="bg-emerald-50 dark:bg-emerald-900/30 border-b border-border/50 backdrop-blur-sm">
 ...
 <div className="relative bg-emerald-500 rounded-3xl p-8 w-40 h-40 mx-auto flex items-center justify-center shadow-2xl">
