...
export default function CheckoutPage() {
  ...
  if (!stripePromise) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-red-50 to-pink-50 dark:from-orange-900/30 dark:via-red-900/30 dark:to-pink-900/30">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50 dark:from-orange-900/30 dark:via-red-900/30 dark:to-pink-900/30 py-12 px-4">
      <div className="container max-w-2xl mx-auto space-y-6">
        ...
        <Card className="border-0 shadow-2xl">
          ...
          <CardContent>
            <div className="flex items-baseline justify-between mb-6 p-6 bg-gradient-to-r from-orange-50 to-pink-50 dark:from-orange-900/20 dark:to-pink-900/20 rounded-xl">
              <div>
