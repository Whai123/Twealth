  ...
  if (isNativeShareAvailable()) {
    return (
      <Button
        ...
        size={size}
        disabled={isLoading}
        className={`${achievement ? 'bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white border-0' : ''} ${className}`}
...
export function AchievementShareCard({ achievement, shareData }: AchievementShareCardProps) {
  ...
  return (
    <Card className="relative overflow-hidden border-2 border-primary/20 bg-gradient-to-br from-white to-purple-50/30 dark:from-gray-800 dark:to-purple-950/20">
