      ...
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          {unreadCount > 0 && (
            <Badge
              variant="destructive"
              className="absolute -top-2 -right-2 h-5 w-5 rounded-full p-0 flex items-center justify-center text-xs font-bold animate-bounce"
          ...
          {isLoading ? (
            ...
            <div className="p-2">
              {recentNotifications.map((notification, index) => (
                <Card
                  key={notification.id}
                  className={`p-3 mb-2 cursor-pointer transition-all duration-200 hover:bg-muted/50 border-l-4 ${
