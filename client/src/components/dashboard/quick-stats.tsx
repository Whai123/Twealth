...
function QuickStats() {
 ...
 const statCards = [
  ...
  },
  {
   ...
   valueColor: monthlySavingsCapacity > 0 ?"text-purple-600 dark:text-purple-400" :"text-red-600 dark:text-red-400",
   sparklineData: capacitySparkline,
   sparklineColor: monthlySavingsCapacity > 0 ? 'purple' as const : 'red' as const,
   trend: capacityTrend,
